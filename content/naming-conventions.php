<section id="naming-conventions">
    <h2 class="heading-1">4. Naming Conventions</h2>
    <h3 class="heading-2" id="client-code">4.1. Client Codes</h3>
    <p>We organize all of our work into projects and those projects are groups by their corresponding client.</p>
    ...
    <h3 class="heading-2" id="project-type">4.2. Project Type</h3>
    <ul class="hanging-list arrow-bullet">
